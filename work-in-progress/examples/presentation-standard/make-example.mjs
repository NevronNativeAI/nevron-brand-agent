...
import {flatten} from '../../presentation-standard/build.mjs';
const house=JSON.parse(fs.readFileSync(new URL('../../presentation-standard/reference/house.json',import.meta.url)));
...
const deck={title:'NevronCore — a connected guest experience',mediaRoot:'../../assets/ppt-extracted/media',
  fontDir:'../../assets/ppt-extracted/fonts',frame:'Full.svg',slides:[
    ...
    {layout:'agenda',label:'Our discussion',section:'Guest experience',text:{'10':'Our discussion','18':['1. Experience','','Guest touchpoints.'],'27':['2. Platform','','Content and services.'],'31':['3. Delivery','','A focused pilot.']}},
    ...
    {layout:'comparison',label:'Operational impact'},
    ...
    {layout:'image-grid',label:'A closer look at the interface',section:'Interface gallery'},
    {layout:'table',label:'Pilot responsibilities',section:'Pilot planning',text:{'8':'A shared delivery plan'},rows:[['Content','Owner','Review'],['Welcome','Hotel team','Before launch'],['Services','Operations','Weekly'],['Feedback','Project team','After pilot']]},
    {layout:'photo',label:'Content in context',text:{'2':[{runs:['Content in context','\n','\n','A better-connected stay','','','']}],'3':'Be content!'}},
