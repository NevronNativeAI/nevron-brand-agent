...
import {chrome} from '../../presentation-standard/build.mjs';
process.env.NEVRON_CHROME_ARGS=JSON.stringify(['--no-sandbox','--in-process-gpu']);
let h=fs.readFileSync('work-in-progress/examples/presentation-standard/deck/index.html','utf8');
...
fs.writeFileSync('work-in-progress/examples/presentation-standard/deck/print-test.html',h);
chrome('work-in-progress/examples/presentation-standard/deck/print-test.html',['--print-to-pdf=C:/Users/Kaja/nevron-brand-agent/work-in-progress/examples/presentation-standard/deck/print-test.pdf','--no-pdf-header-footer']);
